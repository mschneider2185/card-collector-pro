          ...
          <div className="flex justify-center gap-6 mb-8">
            {hasBothImages ? (
              ...
              <div className="max-w-[380px] w-full">
                <div className="rounded-2xl overflow-hidden shadow-xl ring-1 ring-black/5 bg-gradient-to-br from-gray-50 to-gray-100">
                  {frontSrc ? (
                    ...
                    <div className="w-full aspect-[2.5/3.5] bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center">
